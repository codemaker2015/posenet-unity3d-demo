...
public class PoseNetManager : MonoBehaviour
{
    ...
    PrimitiveDraw draw;
    UniTask<bool> task;
    public static PoseNet.Result[] results;
    ...
    void Start()
    {
        ...
        webcamTexture = new WebCamTexture(cameraName, 800, 600, 30);
        webcamTexture.Play();
